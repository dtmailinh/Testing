...
public class BillPaymentTest {
    ...
    public void testPayment1() {
        double output = BillPayment.Tinhtien(10,24);
        double expected = -1;
        double delta = 0.001;
    ...
    */
    public void testPayment2() {
        double output = BillPayment.Tinhtien(10,15);
        double expected = -1;
        double delta = 0.001;
        assertEquals(expected, output, delta);
    }
    ...
    public void testPayment4() {
        double output = BillPayment.Tinhtien(12,17);
    ...
    public void testPayment5() {
        double output = BillPayment.Tinhtien(13,15);
    ...
    public void testPayment6() {
        double output = BillPayment.Tinhtien(17,19);
    ...
    public void testPayment7() {
        double output = BillPayment.Tinhtien(15,21);
